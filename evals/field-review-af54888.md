...
CSV exports** from a live production machine (Transport linear-motor track, AX8000-series drives,
...
| Export K.csv | TAB | `,` | 120 | 40 | 60×1 | 60 | 47247 | 0 |

Acquisition load across the 7 real projects: Transport 16 250, Indexer 11 667, Project C
7 750, Project D 5 750, Project E 4 000, Project F 2 750, Capacity 417
samples/s.
...
signals — ActVelo (axis 2) 1627, ActVelo (axis 1) 1120, ofPosition (axis 2) 939. The reviewer disproved the
...
- **Truncated symbol names.** `Axes.Linear Axis2 (DRV_101_ChB.ActTorque` is missing its
